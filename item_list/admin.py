...
from supplier.models import Supplier  # Import Supplier model
...
class ItemAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        "purchase_cost", "volume_per_unit", "remaining_volume", "cost_per_m", "is_composite", "supplier"
    )
    search_fields = ("name", "description")
    list_filter = ("category", "supplier", "is_for_sale", "is_composite")
